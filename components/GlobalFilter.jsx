...
export default function GlobalFilter({
  ...
  return (
    <div className='flex flex-col space-y-1 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row'>
      <div>
        ...
        <div className='relative'>
          <input
            ...
            className='block w-full py-1 pl-8 pr-2 text-black border border-gray-300 rounded shadow-sm focus:outline-none sm:text-sm'
          />
      ...
      <p className='text-sm text-gray-300'>Menampilkan {count} tim</p>
    </div>
  );
}
